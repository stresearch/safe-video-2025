...
-  The data will consists of real and synthetic videos generated by an older generative models. The videos will cover a wide range of content natural scenes, humans, animanls, etc. (see representaive grid below). The video data will consist of various common comperssion formats, varying resolution, bitrate, FPS and length. The lenght of each clip will vary from a few seconds to 20 seconds.
...
-  Submit here: [https://huggingface.co/spaces/safe-challenge/VideoChallengePilot](https://huggingface.co/spaces/safe-challenge/VideoChallengePilot)
